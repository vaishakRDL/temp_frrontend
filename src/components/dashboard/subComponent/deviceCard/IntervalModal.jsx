...
import { GetChartData } from '../../../../services/LoginPageService';
// import { GetSensorDropdown, UpdateMachineHeaderData, GetChartData } from '../../../Services/NodeJsApiServices';
...
export const IntervalModal = (props) => {
    ...
    return (
        ...
        >
                            ...
                            <Select
                                ...
                                onChange={(e) => {
                                    ...
                                    GetChartData({
                                        ...
                                        tagIds: chartOneTagId,
                                        chartNo: 1,
                                        // slaveId: chartOneSlaveId
            ...
            <DialogActions>
                <Button onClick={() => setIntervalModal(false)} style={{ backgroundColor: isDarkMode ? '#F5F5F5' : '#212529', color: isDarkMode ? '#000000' : '#F5F5F5' }}>Close</Button>
