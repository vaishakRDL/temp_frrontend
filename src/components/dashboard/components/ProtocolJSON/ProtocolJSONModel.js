import { Box, Button, Checkbox, Dialog, DialogContent, DialogTitle, Fab, FormControl, FormControlLabel, Grid, InputLabel, MenuItem, Radio, RadioGroup, Select, TextField, Typography } from '@mui/material'
...
const ProtocolJSONModel = ({ open, setOpen, isAddButton, setRefreshData, editMovabledevice
    , projectId }) => {
            ...
            >
                <form onSubmit={handleSubmit}>
                    <DialogContent style={{ height: '35vh' }}>
                        <DialogTitle style={{ float: 'left', padding: '0px', marginBottom: '10px', width: "100%", display: 'flex', justifyContent: 'center' }}>
                            {isAddButton ? 'Create Json Link' : 'Edit  Json Link'}
                        </DialogTitle>
                        <Grid container spacing={1} >
                            <Grid item xs={10} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <Typography style={{ paddingLeft: 40, width: "60%", fontSize: 20 }}>
                                    Json Link
                                </Typography>
                                <TextField
                                    fullWidth
...
export default ProtocolJSONModel