import React, {
  ...
  import PlantAlertToolbar from '../../PlantAlert/PlantAlertToolbar';
  import PlantAlertModalComponent from '../../PlantAlert/PlantAlertModalComponent';
  import DeleteConfirmationDailog from '../../../utils/confirmDeletion';
  import NotificationBar from '../../notification/ServiceNotificationBar';
  import { useUserAccess } from '../../../context/UserAccessProvider';
  import { PlantAlertSettingsDeleteService, PlantAlertSettingsFetchService, SearchDeviceDataService } from '../../../services/LoginPageService';
            ...
            <Box sx={{ width: '100%' }}>
                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                    <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
                        ...
                        <Tab label="Corrective Action" {...a11yProps(0)} />
                        <Tab label="Energy Saved" {...a11yProps(1)} />
                    </Tabs>
                </Box>
